...
#define LAN8742_PHYSCSR  ((uint16_t)0x001FU)
 ...
 //adin1200
#define ADIN1200_PHY_STATUS_1             0x001AU     /* PHY_STATUS_1 register (vendor/phy core) */
#define ADIN1200_PHY_STATUS_1_AUTONEG_STAT (1U << 12) /* AUTONEG_STAT (bit12) */
#define ADIN1200_HCD_100FD   (0x3U << 7) /* 011 -> 100BASE-TX full duplex */
#define ADIN1200_HCD_100HD   (0x2U << 7) /* 010 -> 100BASE-TX half duplex */
#define ADIN1200_HCD_10FD    (0x1U << 7) /* 001 -> 10BASE-T full duplex */
#define ADIN1200_HCD_10HD    (0x0U << 7) /* 000 -> 10BASE-T half duplex */
#define ADIN1200_PHY_STATUS_1_HCD_TECH_MASK (0x7U << 7) /* bits [9:7] */
#define ADIN1200_IRQ_MASK   0x0018U
#define ADIN1200_IRQ_STATUS 0x0019U
/**
  * @}
  */
...
/** @defgroup LAN8742_IT_Flags LAN8742 IT Flags
  * @{
  */     
 /* Interrupt bit masks in ADIN1200 (IRQ_MASK / IRQ_STATUS registers) */
 #define ADIN1200_IRQ_LINK_CHANGE       (1U << 2)  /* Link status change */
 #define ADIN1200_IRQ_AUTONEG_DONE      (1U << 8)  /* Auto-negotiation status change */
 #define ADIN1200_IRQ_PAGE_RECEIVED     (1U << 6)  /* Auto-negotiation page received */

 /* Legacy LAN8742-compatible names mapped to ADIN1200 bits */
 #define LAN8742_LINK_DOWN_IT           ADIN1200_IRQ_LINK_CHANGE
 #define LAN8742_AUTONEGO_COMPLETE_IT   ADIN1200_IRQ_AUTONEG_DONE
 #define LAN8742_AUTONEGO_LP_ACK_IT     ADIN1200_IRQ_AUTONEG_DONE
 #define LAN8742_AUTONEGO_PAGE_RECEIVED_IT ADIN1200_IRQ_PAGE_RECEIVED

 /* The other LAN8742 interrupt constants have no equivalent in ADIN1200 */
 #define LAN8742_WOL_IT                 0U
 #define LAN8742_ENERGYON_IT            0U
 #define LAN8742_REMOTE_FAULT_IT        0U
 #define LAN8742_PARALLEL_DETECTION_FAULT_IT 0U
/**
  * @}
  */
